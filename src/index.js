const project = {
  "slug": "small-model-router",
  "title": "Small Model Router",
  "version": "1.0.0",
  "tagline": "Route tasks to smaller, local, or private models when they are good enough.",
  "problem": "Many AI workflows overuse frontier models, increasing cost, latency, privacy risk, and vendor dependence.",
  "solution": "A routing policy checker that maps task risk, data sensitivity, quality target, and latency budget to model tiers.",
  "required": [
    "task.kind",
    "task.sensitivity",
    "task.qualityTarget",
